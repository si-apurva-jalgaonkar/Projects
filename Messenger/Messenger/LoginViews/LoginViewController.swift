...
//  Messenger
//
//  Created by Apurva Jalgaonkar on 09/10/23.
//
...
class LoginViewController: UIViewController {
    ...
    private func updatePlaceholderLabels(textField: UITextField) {
        ...
        default:
            repeatPasswordLabelOutlet.text = textField.hasText ? "RepeatPassword" : ""
        }
    }
    ...
    private func registerUser() {
        if passwordTextField.text! == repeatPasswordTextField.text! {
            ...
            ProgressHUD.showFailed("The Passwords dont't match")
        }
    }
    ...
    private func goToApp() {
        let mainView = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "MainView") as!
        UITabBarController
